...
//using MVC_Group7_demo_BLL.Helper;
    ...
    public class ProductController : Controller
    {
        ...
        */
        ...
        public async Task<IActionResult> ByCategory(int categoryId)
        {
            ...
            var (category, error) = await categoryService.GetByIdAsync(categoryId);
            ViewData["Title"] = category != null ? $"{category.Name} Products" : "Unknown Category Products";
